...
const regularChristmasImage = await getLocalImage("./assets/9by16-regular.png");
const saleChristmasImage = await getLocalImage("./assets/9by16-sale.png");

// Layout for 9:16 aspect ratio (same horizontal layout as 4:5)
export function createLayout916Christmas(
