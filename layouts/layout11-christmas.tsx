...
const regularChristmasImage = await getLocalImage("./assets/1by1-regular.png");
const saleChristmasImage = await getLocalImage("./assets/1by1-sale.png");

export function createLayout11Christmas(
